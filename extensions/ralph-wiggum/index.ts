 ...
 * Local workspace copy used by Pi from ~/pi-workspace.
 * Reference upstream: https://github.com/tmustier/pi-extensions/tree/main/ralph-wiggum
...
export default function (pi: ExtensionAPI) {
	...
	function completeLoop(ctx: ExtensionContext, state: LoopState, banner: string): void {
		...
		if (ctx.hasUI) {
			ctx.ui.notify(`Ralph loop complete: ${state.name}`, "info");
		}
